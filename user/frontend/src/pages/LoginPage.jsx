...
export default function LoginPage() {
 ...
 <p className="text-sm text-muted mt-1">Fresh groceries delivered to you</p>
 </div>

 <div className="bg-white rounded-3xl border border-gray-100 shadow-xl p-7">
 <h2 className="text-page-title text-gray-900 mb-1">Welcome Back</h2>
 <p className="text-xs text-muted mb-6">Log in with your registered email and password</p>
 ...
 className="inline-flex items-center gap-1 text-[11px] font-medium text-yellow-900 bg-yellow-200 hover:bg-yellow-300 px-3 py-1 rounded-lg transition"
 >
 ...
 <span className="text-xs text-muted">New to <BrandName size="xs" />?</span>
 <Link
 to="/signup"
 className="w-full text-center py-2.5 rounded-xl border border-gray-200 text-xs font-medium text-gray-700 hover:bg-gray-50 transition"
 >
 Create Account
 </Link>
 </div>
 ...
 By continuing, you agree to <BrandName size="xs" />'s Terms of Service
 </p>
 </div>
 </div>
 );
