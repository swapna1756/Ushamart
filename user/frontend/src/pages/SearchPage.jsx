...
export default function SearchPage() {
 ...
 {/* Search bar header */}
 <div className="sticky top-0 z-20 bg-white shadow-sm px-3 sm:px-4 py-3">
 ...
 className="flex-1 min-w-0 bg-transparent text-sm font-medium focus:outline-none text-gray-800" />
 {query && (
 ...
 <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 pb-24 lg:pb-6">
 {/* Idle state */}
 {!query && (
 <div className="flex flex-col items-center justify-center py-20 text-center">
 <Search size={48} className="text-gray-200 mb-4" />
 <p className="text-sm font-medium text-gray-600">Search for products</p>
