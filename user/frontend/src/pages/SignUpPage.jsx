...
export default function SignUpPage() {
 ...
 <p className="text-sm text-muted mt-1">Create your account to start shopping</p>
 </div>

 <div className="bg-white rounded-3xl border border-gray-100 shadow-xl p-7">
 {!successState ? (
 <>
 <h2 className="text-page-title text-gray-900 mb-1">Create Account</h2>
 <p className="text-xs text-muted mb-6">Fill in your information to register</p>
 ...
 className="w-full py-3 rounded-xl text-xs font-medium text-gray-800 bg-gray-100 hover:bg-gray-200 transition flex items-center justify-center gap-2"
 >
 ...
 className="btn-press w-full py-3.5 rounded-xl text-xs font-medium text-white bg-primary hover:bg-primary-hover transition flex items-center justify-center gap-2"
 >
 Proceed to Login
 </button>
 </div>
