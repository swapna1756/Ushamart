...
export default function ProfilePage() {
 ...
 <h2 className="text-base font-semibold text-gray-800">Sign in to view profile</h2>
 <p className="text-sm text-muted mt-1 mb-6">Manage orders, addresses and account settings</p>
 <button
 ...
 <h1 className="text-page-title text-gray-900 truncate">{fullName}</h1>
 ...
 <h3 className="text-xs font-medium text-gray-800">Edit Profile & Address</h3>

 <div>
 <label className="text-xs font-medium text-label block mb-1">Full Name *</label>
 <input
 type="text"
 ...
 <div>
 <label className="text-xs font-medium text-label block mb-1">Profile Image URL</label>
 <input
 type="url"
 ...
 <div>
 <label className="text-xs font-medium text-label block mb-1">Mobile Number</label>
 <input
 type="tel"
 ...
 <div>
 <label className="text-xs font-medium text-label block mb-1">Saved Address</label>
 <textarea
 ...
 <div>
 <label className="text-xs font-medium text-label block mb-1">Pincode</label>
 <input
 type="text"
 value={form.pincode}
 ...
 <div>
 <label className="text-xs font-medium text-label block mb-1">City</label>
 <input
 type="text"
 value={form.city}
 ...
 <div>
 <label className="text-xs font-medium text-label block mb-1">State</label>
 <input
 type="text"
 value={form.state}
 ...
 type="submit"
 disabled={saving}
 className="btn-press flex-1 py-2.5 rounded-xl text-xs font-medium text-white bg-primary hover:bg-primary-hover disabled:opacity-50 flex items-center justify-center gap-1.5"
 >
 ...
 <span className="text-xs font-medium text-gray-700">Profile Details</span>
 </div>
 ...
 className="btn-press w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl text-sm font-medium text-red-500 bg-red-50 border border-red-200 hover:bg-red-100 transition"
 >
 <LogOut size={15} /> Sign Out
 </button>

 <p className="text-center text-xs text-muted pb-2">
 <BrandName size="xs" /> v1.0 ... All rights reserved
 </p>
 </div>
 </div>
 );
