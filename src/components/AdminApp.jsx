        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-xl p-8">
          <div className="flex flex-col items-center mb-8">
            <div className="w-16 h-16 bg-primary rounded-2xl flex items-center justify-center shadow-lg shadow-primary/25 mb-4">
              <img src="/logo.png" alt="UshaMart" className="w-10 h-10 object-contain" />
            </div>
...
export default function AdminApp({ user, setUser }) {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'orders':     return <PlaceholderPage title="Order Management"     description="Track and manage all customer orders." />;
