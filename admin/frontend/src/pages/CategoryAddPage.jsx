...
export default function CategoryAddPage() {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      // Generate a simple ID if not generated by backend
      const categoryId = 'cat_' + Math.random().toString(36).substring(2, 10);
      await categoriesApi.create({ ...form, id: categoryId });
      ...
      <div className="sticky top-0 z-30 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-lg font-semibold text-gray-900 leading-tight">New Category</h1>
          </div>
        </div>
