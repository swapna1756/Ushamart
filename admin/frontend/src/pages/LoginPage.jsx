...
export default function LoginPage() {
 ...
 <BrandName size="lg" suffix=" Admin" as="h1" className="block" />
 ...
 {/* Email */}
 <div>
 <label className="text-xs font-medium text-label block mb-1.5">
 Email Address
 </label>
 ...
 className="w-full bg-primary hover:bg-primary-hover disabled:opacity-60 text-white font-medium py-3.5 rounded-xl transition shadow-md flex items-center justify-center gap-2 text-sm mt-2">
 ...
 <p className="text-center text-xs text-muted mt-4"><BrandName size="xs" /> Admin Console · Protected Access</p>
 </div>
 </div>
 );
}
